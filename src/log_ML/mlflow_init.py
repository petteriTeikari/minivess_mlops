...
def init_mlflow_run(local_server_path: str,
    ...
    try:
        ...
        logger.error('Failed to initialize the MLflow run (Set experiment name), e = {}'.format(e))
        raise IOError('Failed to initialize the MLflow run (Set experiment name), e = {}'.format(e))
    ...
    try:
        ...
        logger.error('Failed to initialize the MLflow run (Start run), e = {}'.format(e))
        raise IOError('Failed to initialize the MLflow run (Set experiment name), e = {}'.format(e))
