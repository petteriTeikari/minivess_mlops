...
def get_latest_bento_docker(
    ...
    if run_id_tag in tags:
        ...
        logger.info(
            "Bento image on Docker Hub seems to be behind the best model on MLFlow, "
...
def get_bento_CLI_build_command(
    containarize: bool = False,
):
