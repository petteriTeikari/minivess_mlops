...
def ml_test_dataset_for_allowed_types(
    split_file_dict: dict, exts: tuple = (".nii.gz", ".nii")
):
    samples_not_valid = {}
    ...
    for i, sample in enumerate(split_file_dict):
        ...
        problematic_keys = ml_test_metadata_dict(
            metadata_dict=metadata_dict, sample_name=sample_name
        )
...
def ml_test_metadata_dict(metadata_dict: dict, sample_name: str):
    problematic_keys = {}
...
def ml_test_dataset_summary(
    ml_test_dataset: dict,
    ...
    for fold_name in ml_test_dataset:
        ...
        for dataset_name in ml_test_dataset[fold_name]:
            ...
            for split_name in ml_test_dataset[fold_name][dataset_name]:
                ...
                metrics = ml_test_dataset[fold_name][dataset_name][split_name][
                    metric_key
                ]
                boolean = ml_test_dataset[fold_name][dataset_name][split_name][
                    boolean_key
                ]
